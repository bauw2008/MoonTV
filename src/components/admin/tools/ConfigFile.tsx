        ...
        <div className='bg-gradient-to-r from-blue-50/60 via-indigo-50/50 to-purple-50/40 dark:from-blue-900/40 dark:via-indigo-900/30 dark:to-purple-900/20 rounded-2xl p-6 border border-blue-200/50 dark:border-blue-800/50 backdrop-blur-sm'>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
              ...
              {/* 更新时间显示 */}
              <div className='flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 bg-white/60 dark:bg-gray-800/60 px-3 py-2 rounded-lg backdrop-blur-sm'>
        ...
        <div className='bg-gradient-to-br from-emerald-50/40 via-teal-50/30 to-cyan-50/20 dark:from-emerald-900/20 dark:via-teal-900/15 dark:to-cyan-900/10 rounded-2xl p-6 border border-emerald-200/50 dark:border-emerald-800/50 backdrop-blur-sm'>
          ...
          <div className='p-6'>
            ...
            <div className='mt-6 grid grid-cols-2 sm:flex sm:flex-row sm:items-center sm:justify-center sm:space-x-2 gap-3 sm:gap-0 sm:space-y-0'>
              ...
              >
                <RefreshCw
                  className={`w-4 h-4 ${isLoading('api_/api/admin/config') ? 'animate-spin' : ''}`}
                />
                <span>刷新</span>
              </button>

              <label className='flex items-center justify-center space-x-2 px-4 py-3 text-xs bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl cursor-pointer transition-all shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto'>
              ...
              <button
                ...
                className='px-4 py-3 text-xs bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center space-x-1 w-full sm:w-auto'
              >
