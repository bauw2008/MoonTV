  ...
  const menuPanel = (
    <>
      ...
      <div className='fixed top-14 right-4 w-56 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl rounded-2xl shadow-xl z-[1001] border border-gray-200/20 dark:border-gray-700/20 overflow-hidden select-none'>
        {/* 用户信息区域 */}
        <div className='px-3 py-2.5 border-b border-gray-200/30 dark:border-gray-700/30 bg-gradient-to-r from-white/50 to-white/20 dark:from-gray-800/50 dark:to-gray-800/20'>
          <div className='flex items-center gap-3'>
            {/* 用户头像 */}
            <div className='w-10 h-10 rounded-full overflow-hidden relative flex-shrink-0 ring-2 ring-white/50 dark:ring-gray-700/50'>
              {avatarUrl ? (
                <Image
                  src={avatarUrl}
                  alt='用户头像'
                ...
                <div className='w-full h-full bg-gradient-to-br from-blue-400/20 to-blue-600/20 dark:from-blue-600/20 dark:to-blue-800/20 flex items-center justify-center'>
            ...
            <div className='flex-1 min-w-0'>
              <div className='flex items-center justify-between'>
                ...
                <span
                  className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium glass ${
                    (authInfo?.role || 'user') === 'owner'
                      ? 'bg-gradient-to-r from-purple-500/20 to-purple-600/20 text-purple-700 dark:text-purple-300'
                      : (authInfo?.role || 'user') === 'admin'
                      ? 'bg-gradient-to-r from-blue-500/20 to-blue-600/20 text-blue-700 dark:text-blue-300'
                      : 'bg-gradient-to-r from-green-500/20 to-green-600/20 text-green-700 dark:text-green-300'
                  }`}
                >
  ...
  return (
    <>
      <div className='relative'>
        ...
        {updateStatus === UpdateStatus.HAS_UPDATE && (
          <div className='absolute top-[2px] right-[2px] w-2 h-2 bg-yellow-500 rounded-full animate-pulse'></div>
        )}
      </div>
