  ...
  return (
    <>
      <div className='fixed bottom-16 right-6 z-[500] flex flex-col gap-2'>
        ...
        {/* 虚拟滑动开关 - 展开时显示 */}
        {isExpanded && onToggleVirtualization && (
          <div className='relative group/switch'>
            <label className='flex items-center justify-center cursor-pointer'>
              <div className='relative'>
                ...
                />
                <div className='w-7 h-7 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-xl transition-all duration-300 peer-checked:from-blue-500 peer-checked:to-purple-600 peer-checked:text-white shadow-md hover:from-blue-500 hover:to-purple-600 hover:text-white'></div>
                {/* 状态图标 */}
                <div className='absolute inset-0 flex items-center justify-center pointer-events-none'>
                  <Zap
            ...
            <div className='absolute bottom-full right-0 mb-2 px-3 py-1.5 text-xs text-white bg-gray-900/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-lg opacity-0 group-hover/switch:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap shadow-lg'>
              <span className='font-medium'>虚拟滑动</span>
              <div className='absolute top-full right-3 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900/90 dark:border-t-gray-700/90'></div>
            </div>
          </div>
        )}
        ...
        {hasAnyFeatures && (
          <button
            ...
            className={`relative bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-xl w-7 h-7 text-gray-600 dark:text-gray-300 transition-all duration-300 shadow-md hover:shadow-lg hover:from-gradient-to-br hover:from-blue-500 hover:to-purple-600 hover:text-white flex items-center justify-center ${
          ...
          >
            ...
            {/* 提示 */}
            {!isExpanded && (
              <div className='absolute bottom-full right-0 mb-2 px-3 py-1.5 text-xs text-white bg-gray-900/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap shadow-lg'>
