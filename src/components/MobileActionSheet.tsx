...
const MobileActionSheet: React.FC<MobileActionSheetProps> = ({
  ...
  const renderContent = () => (
    ...
    >
      ...
      {/* 操作表单 */}
      <div
        className='relative w-full max-w-lg mx-4 mb-4 bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-2xl shadow-2xl transition-all duration-200 ease-out'
        onTouchMove={(e) => {
